  ...
  return (
    <section id="about" className="py-20">
      <div className="constraint-content w-full">
        ...
        <div id="problem" className="mx-auto mt-14 max-w-5xl rounded-2xl bg-[var(--surface-alt)] p-8">
        ...
        <div
          id="approach"
          className="mx-auto mt-8 max-w-5xl rounded-2xl border border-[var(--border-subtle)] bg-white p-8"
        >
